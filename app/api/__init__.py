...
from app.api import auth, classes, class_bookings, packages, trainers, locations, fitness_programs, gym, wallet, website_config, events
...
api_router.include_router(
    website_config.router,
    prefix="/website-config",
    tags=["website-config"],
)
